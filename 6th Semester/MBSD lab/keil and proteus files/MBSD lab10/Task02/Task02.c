...
result_int = (array[0] -'0') - (array[2] - '0');
if(result_int > 9) //if the result is greater than 9 then we need to store each digit in an array
{
 ...
 result_char = (char)result[0] + '0';//Convert the integer at index 0 to character
 writedata(result_char ); // Echo the key pressed to LCD
 result_char = (char)result[1] + '0';//Convert the integer at index 1 to character
 writedata(result_char ); // Echo the key pressed to LCD
}
else
{
